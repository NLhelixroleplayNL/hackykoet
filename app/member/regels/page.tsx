...
export const metadata = { title: "Regels — GSF Portaal" }
...
const RULES = [
  ...
  },
  {
    title: "Gedragsregels",
    icon: "🤝",
    body: "Ongepast gedrag zoals spam, trollen of het opzettelijk uitlokken van discussies is niet toegestaan. Discussies zijn prima, zolang deze respectvol verlopen. Wij willen dat iedereen zich welkom voelt en zichzelf kan zijn.",
  },
  {
    title: "NSFW",
    icon: "🔞",
...
export default function MemberRegelsPage() {
  return (
    <div className="max-w-3xl mx-auto px-8 py-12">
      ...
      <div className="space-y-4">
        {RULES.map((rule, i) => (
          <Card key={i} className="group relative hover:border-primary/20 transition-colors">
      ...
      <div className="mt-10 p-6 rounded-xl border border-primary/20 bg-primary/5 text-center">
        ...
        <p className="text-muted-foreground text-sm">Door deel te nemen ga je akkoord met bovenstaande regels.</p>
      </div>
    </div>
  )
}
